...
export default function Radar({
  ...
  }, [backgroundColor, brightness, color, enableMouseInteraction, falloff, mouseInfluence, ringCount, ringThickness, scale, speed, spokeCount, spokeThickness, sweepLobes, sweepSpeed, sweepWidth]);
